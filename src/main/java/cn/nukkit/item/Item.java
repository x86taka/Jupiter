...
public class Item implements Cloneable {
    ...
    public static final int IRON_NUGGE = 452;
    ...
    public static void init() {
        if (list == null) {
            ...
            list[EMPTY_MAP] = ItemMapEmpty.class; //395
    ...
    private static void initCreativeItems() {
        ...
        addCreativeItem(Item.get(Item.STAINED_GLASS, 0));
        ...
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 0));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 8));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 7));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 15));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 12));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 14));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 1));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 4));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 5));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 13));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 9));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 3));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 11));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 10));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 2));
        addCreativeItem(Item.get(Item.STAINED_GLASS_PANE, 6));
        ...
        addCreativeItem(Item.get(Item.RED_NETHER_BRICKS, 0));
        ...
        addCreativeItem(Item.get(Item.BONE_BLOCK, 0));
        addCreativeItem(Item.get(Item.NETHER_WART_BLOCK2, 0));
        ...
        //Equipment
        addCreativeItem(Item.get(Item.LEATHER_CAP));//ヘルメット
        ...
        addCreativeItem(Item.get(Item.LEATHER_TUNIC));//チェストプレート
        ...
        addCreativeItem(Item.get(Item.LEATHER_PANTS));//レギンス
        ...
        addCreativeItem(Item.get(Item.LEATHER_BOOTS));//ブーツ
        ...
        addCreativeItem(Item.get(Item.ARROW, ItemArrow.NO_EFFECTS));
        ...
        addCreativeItem(Item.get(Item.ARROW, ItemArrow.DECAY));
        ...
        addCreativeItem(Item.get(Item.SHULKER_BOX, 0));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 8));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 7));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 15));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 12));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 14));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 1));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 4));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 5));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 13));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 9));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 3));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 11));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 10));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 2));
        addCreativeItem(Item.get(Item.SHULKER_BOX, 6));
        ...
        addCreativeItem(Item.get(Item.JUKEBOX, 0));
        addCreativeItem(Item.get(Item.RECORD_13, 0));
        addCreativeItem(Item.get(Item.RECORD_CAT, 0));
        addCreativeItem(Item.get(Item.RECORD_BLOCKS, 0));
        addCreativeItem(Item.get(Item.RECORD_CHIRP, 0));
        addCreativeItem(Item.get(Item.RECORD_FAR, 0));
        addCreativeItem(Item.get(Item.RECORD_MALL, 0));
        addCreativeItem(Item.get(Item.RECORD_MELLOHI, 0));
        addCreativeItem(Item.get(Item.RECORD_STAL, 0));
        addCreativeItem(Item.get(Item.RECORD_STRAD, 0));
        addCreativeItem(Item.get(Item.RECORD_WARD, 0));
        addCreativeItem(Item.get(Item.RECORD_11, 0));
        addCreativeItem(Item.get(Item.RECORD_WAIT, 0));
        ...
        addCreativeItem(Item.get(Item.IRON_NUGGE, 0));
        ...
        addCreativeItem(Item.get(Item.DIRT, 1));
        ...
        addCreativeItem(Item.get(Item.BEETROOT_SOUP, 0));
        ...
        addCreativeItem(Item.get(Item.BROWN_MUSHROOM_BLOCK, 15));
        ...
        addCreativeItem(Item.get(Item.SPAWN_EGG, 29)); //ラマ
...
//        addCreativeItem(Item.get(Item.SPAWN_EGG, 53)); //エンダードラゴン
        ...
        addCreativeItem(Item.get(Item.SPAWN_EGG, 57)); //ヴィンディケーター
        addCreativeItem(Item.get(Item.SPAWN_EGG, 104)); //エヴォーカー
        addCreativeItem(Item.get(Item.SPAWN_EGG, 105)); //ヴェックス
        ...
        addCreativeItem(Item.get(Item.MAGMA_BLOCK, 0));
