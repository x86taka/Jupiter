...
public class PluginMaker {
	...
	private InputStream in = null;   	
	  ...
	  private boolean execCmd(String name) throws IOException, InterruptedException{
			
		String[] cmd = {"jar","cvf", "./makeOrder/" + name + ".jar", "./makeOrder/" + name};
		...
		return true;
	  	...
	  	public boolean Make(String name){
	  		try {
				if(execCmd(name))return true;
				else return false;
